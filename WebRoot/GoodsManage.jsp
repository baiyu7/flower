										...
										<div class="profile-user-info profile-user-info-striped">
											<div class="profile-info-row">
												...
												<div class="profile-info-value">
													<span class="editable" id="username">${sessionScope.username }</span>
												</div>
											</div>
														...
														<c:forEach items="${list }" var="good" begin="1"
															...
															<div
																...
																<a class="example-image-link"
																	href="upload/${good.image }" data-lightbox="example-1"><img
																	class="example-image" src="upload/${good.image }"
																	alt="thumb-1" width="190px" height="190px" /></a>



																<div style="font-size:15px;padding-top:4px">
																	${good.goodsname }<br> <a class="user" href="#"
																		style="color:olive; font-size:16px;">￥${good.price }</a>
																	&nbsp; <span>库存：${good.count }</span><span><a
																		href="modifyGoods?id=${good.id }">修改</a></span> <span><a
																		href="DeleteGoods?goodsid=${good.id }">删除</a></span>
																</div>
															</div>
															<c:if test="${a.index%3 eq 0 }">
																<br>
															</c:if>
														</c:forEach>
														<!-- </tr> -->
