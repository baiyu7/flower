 ...
 超级管理员
							...
							<form action="findUserByName" method="post">
								<div class="container">
									  ...
									  <div class="input-group " >
																	<input type="text" class="form-control search-query col-lg-4" placeholder="请输入用户名包含的关键字" name="username">
   ...
   <c:forEach var="user" items="${requestScope.list }" >
								<tr class="container-flow"
									...
									<td class="col-lg-2"><a href="deleteUser?userid=${user.id }"
										onClick="return confirm()">删除</a></td>
								</tr>
									 </c:forEach>
