 ...
 超级管理员
						...
						<ul class="submenu">
							...
							<li><c:choose>
									...
									<c:when test="${sessionScope.user.rowid  eq 3 }">
										<a href="GoodsManage.jsp"> <i> <class="icon-double-angle-right"></i>
											${functionlist.get(2) }
										</a>
									</c:when>
								</c:choose></li>
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="alert alert-info">
											<i class="icon-hand-right"></i> 请输入您要添加的商品的详细内容！
										...
										<div id="dropzone">
											<form action="AddGoods" class="dropzone dz-clickable"
												enctype="multipart/form-data" method="post">

												商品名称:<input type="text" class="form-control "
													name="goodsname"><br> 商品价格:<input type="text"
													class="form-control" name="price"><br> 商品数量:<input
													type="text" class="form-control" name="count"><br>
