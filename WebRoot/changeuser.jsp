 ...
 超级管理员
						...
						<ul class="submenu">
							...
							<li><c:choose>
									...
									<c:when test="${sessionScope.user.rowid  eq 3 }">
										<a href="UpdateUserServlet"> <i> <class="icon-double-angle-right"></i>
											${functionlist.get(3) }
										</a>
									</c:when>
								</c:choose></li>
						...
						<div class="col-xs-12">
							...
							<table class="table table-striped" align="left"
								...
								<input type="hidden" name="id" value="${user.id }">
										...
										<td class="col-lg-2" ><input name="username" value="${user.username}"></td>
										<td class="col-lg-2" ><input name="password" value="${user.password}"></td>
										<td class="col-lg-2" ><input name="email" value="${user.email}"></td>
										<td class="col-lg-2" >
										<select name="rowid" class="col-lg-12">
										<option value="${user.rowid }" selected="selected">
									   <c:choose>
				                 ...
				                 <c:choose>
								    ...
								    <c:when test="${user.rowid eq 3}">
								     <option value="1">管理员</option>
										...
										<td class="col-lg-2"><button class="btn btn-info " type="submit">
