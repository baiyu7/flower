								...
								<table class="table table-striped" align="left"
									...
									<tr>
										<td><input type="text" class="col-lg-12"
											placeholder="输入用户名" name="username"></td>
										<td><input type="text" class="col-lg-12"
											placeholder="输入密码" name="password"></td>
										<td><input type="text" class="col-lg-12"
											placeholder="输入邮箱" name="email"></td>
										<td><select name="roletype" class="col-lg-12">
										<option value="1">管理人员</option>
										<option value="2">买家</option>
										<option value="3">卖家</option>
										</select>
										</td>
										<td><button type="submit" class="btn btn-warning col-lg-12">添加</button>
</td>		
