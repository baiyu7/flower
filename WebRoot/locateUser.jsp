					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form action="FindUser" method="post">
								...
								<input type="text" class="form-control search-query col-lg-4" placeholder="请输入用户名" name="username">
							...
							<table class="table table-striped" align="left"
								...
								<tr class="container-flow"
									style="font-size:16px;font-family:微软雅黑; text-align:center">
									<td class="col-lg-2"> ${requestScope.user.username }</td>	
									<td class="col-lg-2"> ${requestScope.user.password }</td>	
								    <td class="col-lg-2"> ${requestScope.user.email }</td>	
								    <c:choose>
								    <c:when test="${requestScope.user.rowid eq 1}">
								    <td class="col-lg-2">管理员</td>
								    </c:when>
								    <c:when test="${requestScope.user.rowid eq 2}">
								    <td class="col-lg-2">买家</td>
								    </c:when>
								    <c:when test="${requestScope.user.rowid eq 3}">
								    <td class="col-lg-2">卖家</td>
								    </c:when>
								    <c:otherwise>
